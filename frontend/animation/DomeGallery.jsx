...
export default function DomeGallery({
  ...
  touch-action: none;
    ...
    .stage {
      ...
      inset: 0;
      margin: auto;
     perspective: calc(var(--radius) * 1.5); /* stronger 3D */
perspective: calc(var(--radius) * 3);   /* flatter */
  ...
  `;
    useEffect(() => {
        ...
        const onWheel = (e) => {
            ...
            const sensitivity = 0.01; // tweak this
            ...
            raf = requestAnimationFrame(() => {
                ...
                const nextY = wrapAngleSigned(rotationRef.current.y + dx);
